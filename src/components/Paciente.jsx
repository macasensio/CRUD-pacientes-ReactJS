    ...
    return (
        ...
        <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-md">
            ...
            <div className="flex justify-between mt-10">
                <button
                    type='button'
                    className="bg-indigo-600 py-2 px-10 hover:bg-indigo-700 text-white rounded-md font-bold uppercase"
                    onClick={() => setPaciente(paciente)}
                >Editar</button>

            <button
                    type='button'
                    className="bg-red-600 py-2 px-10 hover:bg-red-700 text-white rounded-md font-bold uppercase"
